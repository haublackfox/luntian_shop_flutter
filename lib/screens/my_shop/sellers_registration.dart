                      ...
                      child: Card(
                        child: Container(
                          ...
                          child: Column(children: [
                            Text(
                                "Note: The seller has the responsibility for shipping the goods to the buyer's destination and Effective commission rate of Luntian app is 2% per product."),
                          ]),
                        ),
                      ),
                    )
